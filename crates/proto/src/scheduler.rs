...
/// Request message for scheduling a secret rotation
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ScheduleSecretRotationRequest {
    /// The ID of the secret to rotate
    #[prost(string, tag = "1")]
    pub secret_id: ::prost::alloc::string::String,
    /// The cron expression defining the rotation schedule (e.g., "0 0 * * \*" for daily at midnight)
    #[prost(string, tag = "2")]
...
pub mod scheduler_service_client {
    ...
    use tonic::codegen::*;
    /// Service for scheduling secret rotations
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Schedule a secret rotation based on the provided request
        pub async fn schedule_secret_rotation(
            &mut self,
            request: impl tonic::IntoRequest<super::ScheduleSecretRotationRequest>,
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/scheduler.SchedulerService/ScheduleSecretRotation",
            );
...
pub mod scheduler_service_server {
    ...
    pub trait SchedulerService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn schedule_secret_rotation(
            &self,
            request: tonic::Request<super::ScheduleSecretRotationRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    /// Service for scheduling secret rotations
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/scheduler.SchedulerService/ScheduleSecretRotation" => {
                    ...
                    struct ScheduleSecretRotationSvc<T: SchedulerService>(pub Arc<T>);
                    impl<T: SchedulerService>
                        tonic::server::UnaryService<super::ScheduleSecretRotationRequest>
                        for ScheduleSecretRotationSvc<T>
                    {
                        type Response = ();
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SchedulerService>::schedule_secret_rotation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = ScheduleSecretRotationSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "scheduler.SchedulerService";
