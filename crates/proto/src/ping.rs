...
pub mod ping_service_client {
    ...
    /// Service for ping/pong communication
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Unary RPC method for pinging the server
        pub async fn ping(
            &mut self,
            ...
            let path = http::uri::PathAndQuery::from_static("/ping.PingService/Ping");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("ping.PingService", "Ping"));
...
pub mod ping_service_server {
    ...
    /// Service for ping/pong communication
    #[derive(Debug)]
    pub struct PingServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> Clone for PingServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "ping.PingService";
